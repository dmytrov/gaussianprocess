"""
Benchmark script to be used to evaluate the performance improvement of the MKL with numpy.

This benchmark is quiet rough and does not pretend to be accurate. It just give an information 
on the timing for different linear algebra functions. If you report your timing results with 
architecture information, I will collect and publish the results.
